...
public class SwaggerConfig {
	...
	private ApiInfo getInfo() {
		return new ApiInfo("Blogging Application : Backend Course",
				"This project is developed by Sagor with the help of LCWD", "1.0", "Terms service",
				new Contact("Sagor", "https://learncode.com", "sagormondol179@gmail.com"), "License of APIS",

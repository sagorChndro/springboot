...
public class CourseServiceImpl implements CourseService {
    ...
    @Autowired
    public CourseServiceImpl(CourseRepository courseRepository, ModelMapper modelMapper, MailService mailService) {
    ...
    public Response save(CourseDto courseDto) {
        ...
        mailService.sendNonHtmlMail(to, "Test"," Hello Subinoy");

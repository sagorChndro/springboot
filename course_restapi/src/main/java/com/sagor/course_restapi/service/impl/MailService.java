...
import com.sagor.course_restapi.utils.EmailConstraint;
import com.sagor.course_restapi.utils.EmailStatus;
...
public class MailService {
    ...
    public EmailStatus sendMimeMail(String []to, String subject, String body, Boolean isHtml, List<File> attachment){
        try{
            ...
            logger.error("Error is send to"+to[0]+" message"+e.getMessage());
        }
